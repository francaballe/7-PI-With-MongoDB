...
const OneCountry = (props) => {  
  const {_id,name,continent,subregion,population,flagImg} = props;
      ...
      <div className={dayOrNigth==="NIGHT"?style_black.mainContainer_black:style.mainContainer}>
          ...
          <div className={style.countryInfo}>
            ...
            <Link to={`/countries/${_id}`}> 
              <button className={dayOrNigth==="NIGHT"?style_black.myButton_black:style.myButton}>Detailed Info</button>
            </Link>
          </div>
      </div>
    );
