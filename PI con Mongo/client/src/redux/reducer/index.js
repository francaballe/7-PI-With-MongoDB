  ...
  function rootReducer (state = initialState, action) {
    ...
    switch(action.type) {
        ...
        case "GET_COUNTRIES_BY_ACTIVITY":
          ...
          const intersection5 = array7.filter(item1 => array8.some(item2 => item1._id === item2._id))
          ...
          const intersection6 = intersection5.filter(item1 => array9.some(item2 => item1._id === item2._id))
        ...
        case "GET_COUNTRY":
          ...
          //hago nuevamente la interseccion
          const intersection3 = array4.filter(item1 => array5.some(item2 => item1._id === item2._id))

          //y otra vez
          const intersection4 = intersection3.filter(item1 => array6.some(item2 => item1._id === item2._id))
        ...
        case "GET_COUNTRIES_LIKE": //en mi payload viene un array de paises según el criterio de nombre escrito
          ...
          const intersection1 = array1.filter(item1 => array2.some(item2 => item1._id === item2._id))

          //hago nuevamente la interseccion
          const intersection2 = intersection1.filter(item1 => array3.some(item2 => item1._id === item2._id))
